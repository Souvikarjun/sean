...
const topbar = () => {
  return (
    <div className='w-screen bg-primary/90 m-0 py-1 shadow-md flex items-center justify-between text-white text-sm xl:px-[15%] sm:px-1 sm:text-xs xs:px-1 xs:text-xs'>
